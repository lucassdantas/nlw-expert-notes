        ...
        <Dialog.Root>
            ...
            <Dialog.Content className='fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-700 max-w-[640px] h-[60vh] w-full rounded-md flex flex-col outline-none'>
                ...
                <div className='flex flex-1 flex-col gap-3 p-5 '>
                    ...
                    <p className='text-sm leading-6 text-slate-400'>
                        Comece <button className='font-medium text-lime-400 hover:underline '>gravando uma nota</button> em áudio ou se preferir <button className='font-medium text-lime-400 hover:underline '>use apenas texto.</button>
                    </p>
                </div>
